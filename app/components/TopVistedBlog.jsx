// app/blogs/TopVisitedBlogs.jsx
"use client"
import React, { useEffect, useState } from 'react';
import Slider from 'react-slick';
import { FaEye } from 'react-icons/fa'; // For eye icon
...
const TopVisitedBlogs = () => {
  ...
  return (
    <div className="my-16 px-4">
      ...
      <Link href="/blogs">
          <button 
            className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600  hover:scale-110 transition duration-300">
            View More
          </button>
        </Link>
        </div>
